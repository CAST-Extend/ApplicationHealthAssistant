...
import { queryForElement } from '@application-health-assistant/shared-utils-testing';
...
describe('AppComponent', () => {
    ...
    it("should have as title 'Application Health Assistant'", () => {
        const fixture = TestBed.createComponent(AppComponent);
        const app = fixture.componentInstance;
        expect(app.title).toBe('Application Health Assistant');
    });

    it('should correctly inject the okta dependency from the injection token', () => {
        const testOktaAuth = TestBed.get(OKTA_CONFIG);
        const fixture = TestBed.createComponent(AppComponent);
